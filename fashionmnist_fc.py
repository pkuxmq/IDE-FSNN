...
parser = argparse.ArgumentParser(description='PyTorch FashionMNIST SNN Training')
# Datasets
...
# SNN settings
parser.add_argument('-t', '--time_step', default=5, type=int)
...
def main():
    ...
    config = {}
    config['MODEL'] = {}
    config['MODEL']['dim_in'] = in_planes * in_pixels * in_pixels
    config['MODEL']['dim_hidden'] = 400
