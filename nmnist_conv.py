...
import numpy as np
from models.snn_ide_conv import SNNIDEConvNet
from loadNMNIST_Spiking import get_nmnist

from utils import Bar, Logger, AverageMeter, accuracy, mkdir_p, savefig

parser = argparse.ArgumentParser(description='PyTorch NMNIST SNN Training')
# Datasets
parser.add_argument('-d', '--dataset', default='nmnist', type=str)
parser.add_argument('--path', default='./data/NMNIST/2312_3000_stable/', type=str)
...
def main():
    ...
    config['MODEL']['h_hidden'] = 16
    config['MODEL']['w_hidden'] = 16
    ...
    config['OPTIM'] = {}
    config['OPTIM']['solver'] = 'iter'
    model = SNNIDEConvNet(config)
